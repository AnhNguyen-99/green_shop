...
// chỉ định cho pring biết là mk đang dùng giải thuật này

	//để sử dụng đk thì phải thêm bean vào
	@Bean
	...
	// sử dụng cái passwordEncoder để mã hóa mật khẩu
	@Autowired
